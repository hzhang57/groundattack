...
from vlm.llm_gpt_oss import gpt_4o_mini
...
def main():
    ...
    parser.add_argument("--distractor-model-path", type=str, default="gpt-4o-mini")
    ...
    elif "gpt-4o-mini" in args.distractor_model_path:
        llm = gpt_4o_mini(api_key="")
